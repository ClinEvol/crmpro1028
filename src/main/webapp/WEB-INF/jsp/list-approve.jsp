                   ...
                   <div class="ibox-content">
                        ...
                        <div class="row">
							...
							<div class="col-sm-12 text-right">
                                <div class="btn-group">
                                    <a href="/baoxiao/list?pageNum=${page.pageNum-1}&keyword=${keyword}&type=${type}&status=1" class="btn btn-sm btn-white <c:if test="${page.pageNum-1<1}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-left"></i></a>
                                    <c:forEach begin="1" end="${page.pages}" varStatus="index">
                                        <a href="/baoxiao/list?pageNum=${index.index}&keyword=${keyword}&type=${type}&status=1" class="btn btn-sm btn-white <c:if test="${page.pageNum==index.index}">active</c:if> ">${index.index}</a>
                                    </c:forEach>
                                    <a href="/baoxiao/list?pageNum=${page.pageNum+1}&keyword=${keyword}&type=${type}&status=1" class="btn btn-sm btn-white <c:if test="${page.pageNum+1>page.pages}">disabled</c:if> "><i class="glyphicon glyphicon-chevron-right"></i></a>
                                </div>
							</div>
                        </div>
