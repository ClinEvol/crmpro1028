                            ...
                            <table class="table table-striped list-table">
                                ...
                                <tbody>
                                    <tr>
										...
										<td>2017-02-03</td>
                                        <td class="text-right">
	                                        	<a href="show-indexvalue.jsp" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> 查看</a>
	                                        	<a href="show-ben.jsp" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> 编辑</a>
	                                        	<a href="show-ben.jsp" class="btn btn-danger btn-xs"><i class="fa fa-download"></i> 附件下载</a>
                                        </td>
                                    </tr>
