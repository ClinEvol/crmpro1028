                        ...
                        <input type="hidden" name="id" value="${notice.id}">
                         <div class="row">
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-9">
                                     <input value="${notice.title}" name="title" type="text" class="form-control" >
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             <div class="form-group">
                                 <div id="file-pretty">
                                     ...
                                     <div class="col-sm-4">
                                         <!---->
                                         <input name="myfile" value="${notice.path}" type="file" class="form-control" >
                                     </div>
                                     <label class="col-sm-4 text-left">如果不需要修改附件则不用选择</label>
                                 </div>
                             </div>
                         </div>
 ...
 <script>
     $(document).ready(function() {
         ...
         $("#btnSend").click(function () {
             ...
             $.ajax({
                 url: "/administration/notice/update",
                 type: 'POST',
                 dataType:"text",
                 ...
                 success:function(response) {
                     if(response=="true"){
                         //使用甜心弹框提示
                         swal({title:"修改成功",text:"数据已经成功添加到数据库",type:"success"},function(){
